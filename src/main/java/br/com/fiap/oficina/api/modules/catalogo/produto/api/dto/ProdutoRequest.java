...
public record ProdutoRequest(
                ...
                @NotNull(message = "A quantidade é obrigatório") @JsonProperty("quantidade_estoque") @Schema(description = "preço unitario do produto", defaultValue = "10") BigDecimal quantidadeEstoque,
                @NotNull(message = "A unidade de medida é obrigatória") @JsonProperty("unidade_medida") @Schema(description = "preço unitario do produto", defaultValue = "UN") UnidadeMedida unidadeMedida) {
