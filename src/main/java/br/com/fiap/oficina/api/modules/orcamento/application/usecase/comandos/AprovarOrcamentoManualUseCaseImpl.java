...
public class AprovarOrcamentoManualUseCaseImpl implements AprovarOrcamentoManualUseCase {
    ...
    public void executar(UUID orcamentoId, String assinaturaUrl, List<UUID> servicosAceitos, List<UUID> servicosRejeitados) {
        ...
        OrcamentoAceitoEvent event = new OrcamentoAceitoEvent(orcamento.getId(), orcamento.getOrdemServicoId(), servicosAceitos, servicosRejeitados);
        ...
        eventBus.publish(OrcamentoAceitoEvent.TOPICO, event.toJson());
    }
}
