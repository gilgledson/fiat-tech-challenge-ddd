...
public record AprovarServicoRequest(
    @Schema(description = "Lista de IDs de serviços que foram aprovados pelo cliente")
    List<UUID> servicosAprovados,

    @Schema(description = "Lista de IDs de serviços que foram rejeitados pelo cliente")
